package com.microservices.demo.twitter.kafka.service.listener;

import com.microservices.demo.config.KafkaConfigData;
import com.microservices.demo.kafka.avro.model.TwitterAvroModel;
import com.microservices.demo.kafka.producer.config.service.KafkaProducer;
import com.microservices.demo.twitter.kafka.service.transformer.TwitterStatusToAvroTransformer;
...
public class TwitterKafkaStatusListener extends StatusAdapter {
    ...
    public TwitterKafkaStatusListener(KafkaConfigData kafkaConfigData, KafkaProducer<Long, TwitterAvroModel> kafkaProducer, TwitterStatusToAvroTransformer twitterStatusToAvroTransformer) {
        ...
        this.twitterKafkaStatusListener = this;
